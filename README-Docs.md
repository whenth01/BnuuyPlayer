...
#### Flat playlists
  ...
  audio_funct is what does the subprocess call to MPV to begin playing, playlist_picker and lib_print handle compiling the necessary information for audio_funct. (Note: lib print modifies the actual database to be sorted, the name will be changed soon.)
